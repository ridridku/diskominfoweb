            ...
            <ul class="list-group">
              <?php 
                  ...
                  echo "<li class='list-group-item'>User Online <span class='badge'>$pengunjungonline</span></li>
                        ...
                        <li style='background-color:#fe9900' class='list-group-item alert'>Total pengunjung <span class='badge'>$totalpengunjung[total]</span></li>";
              ?>
            </ul>
            </div>
            ...
            <?php
                ...
                foreach ($banner->result_array() as $rows){
                  if ($rows['gambar']==''){
                    ...
                    echo "<img class='img-thumbnail'  src='".base_url()."asset/foto_banner/$rows[gambar]'>";
                  }
                }
            ?>
            </div>
