...
<html lang="en">
  <head>
   <title><?php include "phpmu-title.php"; ?></title>
    ...
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/flexslider.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/fontawesome-all.css" rel="stylesheet" media="screen" />
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/ken-burns.css" rel="stylesheet" media="screen" />
    <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/slider.css" rel="stylesheet">
      <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/style.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/swipebox.css" rel="stylesheet">
