...
<title> Intrend Interior Category Flat Bootstrap Responsive Website Template | Index : W3layouts</title>
	...
	<!--// Meta tag Keywords -->
	 ...
	 <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/slider.css" type="text/css" rel="stylesheet" media="all"> 
	
	<!-- css files -->
	 <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/bootstrap.css"> <!-- Bootstrap-Core-CSS -->
	 <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/style.css" type="text/css" media="all" /> <!-- Style-CSS --> 
	 <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/fontawesome-all.css"> <!-- Font-Awesome-Icons-CSS -->
	<!-- //css files -->
	
	<!-- testimonials css -->
	 <link href="<?php echo base_url(); ?>template/<?php echo template(); ?>/css/flexslider.css" type="text/css" media="screen" property="" /><!-- flexslider css -->
	<!-- //testimonials css -->
...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="index.html">DISKOMINFO</span></a></h1>
...
<!-- js-scripts -->		
	...
	<!-- js -->
	<script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/jquery-2.2.3.min.js"></script>
        <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/bootstrap.js"></script>
      <!-- Necessary-JavaScript-File-For-Bootstrap --> 
	<!-- //js -->
	
	<!-- banner js -->
	  <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/snap.svg-min.js"></script>
	 <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/main.js"></script><!-- Resource jQuery -->  
	<!-- //banner js --> 

	<!-- flexSlider --><!-- for testimonials -->
	<script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/jquery.flexslider.js"></script>
	...
	<!-- start-smoth-scrolling -->
        ...
        <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/SmoothScroll.min.js"></script>
	  <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/move-top.js"></script>
	<script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/easing.js"></script>
	<script type="text/javascript">
...
<!-- //js-scripts -->
    ...
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/jquery.countup.js"></script>
   
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/jquery.swipebox.min.js"></script>
    <script src="<?php echo base_url(); ?>template/<?php echo template(); ?>/js/jquery.waypoints.min.js"></script>
